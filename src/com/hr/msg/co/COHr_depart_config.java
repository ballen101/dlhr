...
@ACO(coname = "web.hrkq.depart")
public class COHr_depart_config extends JPAController {


	@ACOAction(eventname = "imdepartportexcel", Authentication = false, ispublic = false, notes = "导入消息配置")
